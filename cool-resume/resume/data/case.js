...
var casees = [
		{
			...
			caseList:[
				...
				},
				{
					...
					caseDescription:"描述：这是JS的热身运动练习，这是学习之前看过JS视频以后，需要独立完成的练习内容，涉及到的知识点有：布局练习、元素获取、样式设置这是JS的热身运动练习，这是学习之前看过JS视频以后，需要独立完成的练习内容，涉及到的知识点有：布局练习、元素获取、样式设置这是JS的热身运动练习，这是学习之前看过JS视频以后，需要独立完成的练习内容，涉及到的知识点有：布局练习、元素获取、样式设置这是JS的热身运动练习，这是学习之前看过JS视频以后，需要独立完成的练习内容，涉及到的知识点有：布局练习、元素获取、样式设置这是JS的热身运动练习，这是学习之前看过JS视频以后，需要独立完成的练习内容，涉及到的知识点有：布局练习、元素获取、样式设置这是JS的热身运动练习，这是学习之前看过JS视频以后，需要独立完成的练习内容，涉及到的知识点有：布局练习、元素获取、样式设置这是JS的热身运动练习，这是学习之前看过JS视频以后，需要独立完成的练习内容，涉及到的知识点有：布局练习、元素获取、样式设置这是JS的热身运动练习，这是学习之前看过JS视频以后，需要独立完成的练习内容，涉及到的知识点有：布局练习、元素获取、样式设置这是JS的热身运动练习，这是学习之前看过JS视频以后，需要独立完成的练习内容，涉及到的知识点有：布局练习、元素获取、样式设置……"
					,caseWebsite:"http:www.miaov.com"
				}
			]
		},
