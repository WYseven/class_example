    ...
    document.getElementById("intro_table").style.height=introHeight+'px';
...
function loadhandle(){
	...
	var _src = contentImg.getAttribute("_src");
	...
	if( _src !== '' ){
		...
		imgs.onload = function (){
			...
			var w = contentImg.offsetWidth;
			var h = contentImg.offsetHeight;
			var scale = w/560;
			if( w > 560 ){
				contentImg.style.width = "560px";
				contentImg.style.height = h / scale + 'px';
